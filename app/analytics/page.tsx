        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 mt-6">
          ...
          <div className="h-full flex items-end justify-between gap-3">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500 mt-2">Mon</p>
            </div>

            <div className="flex flex-col items-center">
              <div className="bg-green-500 w-10 h-32 rounded-t-md"></div>
              <p className="text-sm text-gray-500 mt-2">Tue</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500 mt-2">Thu</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500 mt-2">Sun</p>
            </div>
